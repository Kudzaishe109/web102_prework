...
// show the highest funded game in a message
const highestFundedGame = sortedGames[0];
const bonusMessage = document.createElement("p");
bonusMessage.textContent = `🎉 The highest funded game is "${highestFundedGame.name}" with $${highestFundedGame.pledged.toLocaleString()} pledged!`;
descriptionContainer.appendChild(bonusMessage);
